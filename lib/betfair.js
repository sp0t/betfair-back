...
const getBtOdds = async(monitid, sportname, sportid, leagueid, markets, inPlayOnly, username, password, tm) => {
  ...
  console.log('Betfair Time intaval =======1======>', timestamp2 - timestamp1);
  ...
  console.log('Betfair Time intaval ======2 =======>', timestamp3 - timestamp2);
  ...
  console.log('Betfair Time intaval ======3=======>', timestamp4 - timestamp3);
  ...
  console.log('Betfair Time intaval ======4=======>', timestamp5 - timestamp4);
  ...
  if (funcs.length != 0)
    ...
    console.log('Betfair Time intaval =======5======>', timestamp6 - timestamp5);
...
const saveData = async(monitid, sportid, sportname, leagueid, leaugename, eventid, away, home, gamedate, market, update) => {
  ...
  var [odd, matchdata] = await Promise.all([
    ...
    match.findOneAndUpdate({monitId:monitid, away: away, home: home, gamedate: { $regex: gameregex, $options: 'i' }, state: 0}, 
      {
        monitId:monitid,
        sportName: sportname,
