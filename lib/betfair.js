...
const getBtOdds = async(sportId, leagueids, markets, inPlayOnly, username, password, tm) => {
  ...
  for (x in catalogue[sportId]) {
    console.log('============ordrer', x);
    if (catalogue[sportId][x].hasOwnProperty('marketName')) {
      if (markets.includes(catalogue[sportId][x].marketName)) {
        console.log('======================1',catalogue[sportId][x].event.id, catalogue[sportId][x].marketId, catalogue[sportId][x].marketName, x)
        if (catalogue[sportId][x].marketName == 'Moneyline') {
          console.log('======================2',catalogue[sportId][x].event.id, catalogue[sportId][x].marketId, catalogue[sportId][x].marketName, x)
          ...
          console.log('======================3',catalogue[sportId][x].event.id, catalogue[sportId][x].marketId, catalogue[sportId][x].marketName, x)
