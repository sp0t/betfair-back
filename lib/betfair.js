...
const getBtOdds = async(monitid, sportname, sportid, leagueid, markets, inPlayOnly, username, password, tm) => {
  ...
  console.log('Betfair Time intaval1 =============>', timestamp2 - timestamp1);
  ...
  console.log('Betfair Time intaval2 =============>', timestamp3 - timestamp2);
  ...
  console.log('Betfair Time intaval3 =============>', timestamp4 - timestamp3);
  ...
  console.log('Betfair Time intaval4 =============>', timestamp5 - timestamp4);
  ...
  if (funcs.length != 0)
    ...
    console.log('Betfair Time intaval4 =============>', timestamp6 - timestamp5);
