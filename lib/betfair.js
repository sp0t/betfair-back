  ...
  for (x in catalogue) {
    if (marketid.includes(catalogue[x].marketName)) {
      ...
      if (catalogue[x].marketName == 'Handicap') {
        ...
        if (marketbook.runners) {
          for (var y in marketbook.runners) {
            market.handicap[marketbook.runners[y].handicap] = {}
            if (marketbook.runners[y].selectionId == catalogue[x].awayid) market.handicap[marketbook.runners[y].handicap].away = marketbook.runners[y].ex 
            if (marketbook.runners[y].selectionId == catalogue[x].homeid) market.handicap[marketbook.runners[y].handicap].home = marketbook.runners[y].ex 
          }
        }
      }
