  ...
  for (x in catalogue) {
    if (catalogue[x].hasOwnProperty('marketName')) {
      if (markets.includes(catalogue[x].marketName)) {
        console.log('======================1',catalogue[x].event.id, catalogue[x].marketId, catalogue[x].marketName)
        if (catalogue[x].marketName == 'Moneyline') {
          console.log('======================2',catalogue[x].event.id, catalogue[x].marketId, catalogue[x].marketName)
          ...
          sportName[catalogue[x].event.id] = catalogue[x].eventType.name;
          ...
          marketbook = tmpmarketbook.data[0];

          console.log('======================3',catalogue[x].event.id, catalogue[x].marketId, catalogue[x].marketName)
