...
const placebet = async(site1, competition1, site2, competition2, stakemode, seesion) => {
                ...
                if ((odd1[x].home == odd2[y].home) && (odd1[x].away == odd2[y].away) && (odd1[x].mornitId == odd2[y].mornitId)) {
                    ...
                    if (odd1[x].stakemode.state) {
                        ...
                        for (var z in stakemode) {
                            if (stakemode[z].diffmode == 0) {
                                if (stakemode[z].betmode == 0) {
                                    if (btawayprice < bthomeprice) {
                                        if ((stakemode[z].from <= Math.abs(btawayprice - psawayprice)) && Math.abs((btawayprice - psawayprice) < stakemode[z].to)) 
                                        {
                                            funcs.push(betting(odd1val.moneyline.marketid, odd1val.moneyline.awayid, btawayprice, stakemode[z].stake, token, odd1[x].eventId, odd1[x].away, odd1[x].home, competition1, odd1[x].away, btawayprice, bthomeprice, psawayprice.toFixed(2), pshomeprice.toFixed(2)))
                                            break;
                                        }
                                    }
                                    else {
                                        ...
                                        {
                                            funcs.push(betting(odd1val.moneyline.marketid, odd1val.moneyline.homeid, bthomeprice, stakemode[z].stake, token, odd1[x].eventId, odd1[x].away, odd1[x].home, competition1, odd1[x].home, btawayprice, bthomeprice, psawayprice.toFixed(2), pshomeprice.toFixed(2)))
                                            break;
                                        }
                                    }
                                } else {
                                    var fund = stakemode[z].stake * totalfund / 100 >  stakemode[z].max ? stakemode[z].max : stakemode[z].stake * totalfund / 100;
                            ...
                            } else if (stakemode[z].diffmode == 1) {
                                if (stakemode[z].betmode == 0) {
                                    if (btawayprice < bthomeprice) {
